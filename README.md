...
- [Build AI services using the SAP Cloud Application Programming Model, SAP AI Core and Generative AI Hub](#build-ai-services-using-the-sap-cloud-application-programming-model-sap-ai-core-and-generative-ai-hub)
...
- [Optional Exercise 09 - Prompt Engineering with AI Launchpad](./exercises/09-prompt-engineering-with-ai-launchpad/readme.md)
